...
class MLP(Layer):
    ...
    def __init__(self, layers, batch_size=None, input_space=None,
                 ...
                 layer_name=None, silence=False, **kwargs):
    ...
    # @wraps(Layer.get_output_source)
    # def get_output_source(self):
    #
    #     return self.layers[-1].get_output_source()
    #
    # @wraps(Layer.get_target_source)
    ...
    def get_layer_monitoring_channels(self, state_below=None,
        ...
        for layer in self.layers:
            ...
            if layer is self.layers[-1] or not self.silence:
...
class CompositeLayer(Layer):
    ...
    def get_params(self):
        rval = []
        for layer in self.layers:
            rval = safe_union(rval,layer.get_params() )
        return rval
